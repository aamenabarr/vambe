...
export function MetricsCards({ averageLeadScore, hotLeadsCount, totalLeads, closeRate, hotLeadsCloseRate, }) {
    return (<div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4">
