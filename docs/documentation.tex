...
\begin{itemize}[noitemsep]
  ...
  \item \textbf{Listado de Leads} (Tabla paginada): click abre modal con detalle completo incluyendo insights IA y transcripción. Incluye buscador.
\end{itemize}
...
src/
  ...
  lib/
    ...
    db/
      ...
      leads.ts             # getLeads, postLeads, getUnprocessedLeads, updateLeadWithInsights
    fetchers/
